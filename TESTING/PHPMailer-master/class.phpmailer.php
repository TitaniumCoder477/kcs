...
class PHPMailer
{
     ...
     * To generate iCal events, use the bundled extras/EasyPeasyKCS.php class or iCalcreator
     * @link http://sprain.ch/blog/downloads/php-class-easypeasykcs-create-ical-files-with-php/
