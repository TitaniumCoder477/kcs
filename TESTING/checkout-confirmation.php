...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">
			<script>
				document.write("<a href='index.php'>Users</a> > " + getCookie("kcs_user_name") + " > <a href='" + getCookie("kcs_option_path") + "'>" + getCookie("kcs_option") + "</a> > <a href='items.php'>" + getCookie("kcs_category") + "</a> > Check Out Confirmation");
			</script>	
		</h3>
	</div>
		...
		<div class='panel panel-info'>
			...
			<?php
				...
				try {
					...
					$sql = "UPDATE Items SET USER_EMAIL_FK='$email',DATE_OUT='$date' WHERE CATEGORY_FK='$category' AND ITEM='$item'";
					$sth = $db_conn->prepare($sql);
					$sth->execute();
					
					$sql = "INSERT INTO User_Options VALUES('$email','Check In','$category','$item')";
					$sth = $db_conn->prepare($sql);
					$sth->execute();				
